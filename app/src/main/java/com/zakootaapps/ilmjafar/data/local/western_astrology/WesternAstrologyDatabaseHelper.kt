package com.zakootaapps.ilmjafar.data.local.western_astrology
...
class WesternAstrologyDatabaseHelper(private val context: Context) : 
    SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {

    companion object {
        private const val DATABASE_NAME = "western_astrology.db"
    ...
    private fun copyDatabaseIfNeeded() {
        ...
        if (!dbFile.exists() || currentVersion < DATABASE_VERSION) {
            ...
            try {
                context.assets.open("western_astrology_db/western_astrology.db").use { input ->
    ...
    override fun onCreate(db: SQLiteDatabase) {
        // Not needed as we copy the pre-populated database
    }
